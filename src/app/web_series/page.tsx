          ...
          {[1,2,3].map(i => (
            <div key={i} className="bg-white/10 rounded-xl shadow-lg p-8 flex flex-col md:flex-row items-center w-full">
              ...
              <div className="flex-1 flex flex-col justify-center items-start">
                <h2 className="text-3xl font-bold text-white mb-2">Web Series Title {i}</h2>
                <p className="text-gray-300 mb-2 text-lg">Genre: Drama</p>
                <p className="text-gray-400 text-md mb-4">A longer description of Web Series {i}. This is a dummy card for layout preview. The details section is wide and stretches across the page for a cinematic look. You can add more info here as needed.</p>
                <p className="text-gray-400 text-md mb-2">Year: 2022</p>

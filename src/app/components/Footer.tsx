        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
          <div className="bg-gray-900 rounded-xl shadow-lg p-8 flex flex-col items-center min-w-[320px] relative" style={{ fontFamily: 'Lora, serif' }}>
            ...
            <div className="flex gap-6 mb-2">
              ...
              <a href="https://instagram.com/utsh0x" target="_blank" rel="noopener noreferrer" className="text-gray-200 hover:text-yellow-300 text-2xl" title="Instagram">
                <svg fill="currentColor" viewBox="0 0 24 24" className="w-7 h-7">
              ...
              <a href="https://x.com/utsh0w" target="_blank" rel="noopener noreferrer" className="text-gray-200 hover:text-yellow-300 text-2xl" title="X">
                <svg fill="currentColor" viewBox="0 0 24 24" className="w-7 h-7">
              ...
              <a href="mailto:utshozi11@gmail.com" className="text-gray-200 hover:text-yellow-300 text-2xl" title="Mail">
                <svg fill="currentColor" viewBox="0 0 24 24" className="w-7 h-7">
